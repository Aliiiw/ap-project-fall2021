...
public class SearchBox extends javax.swing.JFrame {
    ...
    private void textsearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_textsearchActionPerformed
        ...
        try {
            ...
            //String sqlOrder = "SELECT user.username,block.blocker,block.blocked FROM user,block WHERE user.username LIKE ? AND block.blocker <> ? AND block.blocked <> ?";
            String sqlOrder = "SELECT username FROM user WHERE username LIKE ?";
            PreparedStatement preparedStatement = connector.prepareStatement(sqlOrder);
            preparedStatement.setString(1, "%" + textsearch.getText() + "%");
//            preparedStatement.setString(2, textsearch.getText());
//            preparedStatement.setString(3, Login.usernameHelper);
            ...
            model.addRow(new Object[] {resultSet.getString("username")});
            }
            connector.close();
